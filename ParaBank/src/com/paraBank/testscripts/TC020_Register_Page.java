...
public class TC020_Register_Page {

@Test	
	public static void tc020() throws Exception
	{
	//enter only alphabets in "username, password & confirm password" textboxes
		...
		Register_Page.loginDetails("vajvsajhsaj", "anil", "anil");
